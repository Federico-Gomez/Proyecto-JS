...
const carreras = [
    ...
    new Carrera("Derecho", "5 años", 36, "cs_sociales", 1900000),
    new Carrera("Economía", "5 años", 25, "cs_sociales", 1900000),
    new Carrera("Administración de Empresas", "5 años", 26, "cs_sociales", 1900000),
    new Carrera("Administración Actuarial", "5 años", 26, "cs_sociales", 1900000),

    new Carrera("Arquitectura", "5 años", 28, "arquitectura", 1950000),
    new Carrera("Diseño Gráfico", "5 años", 24, "arquitectura", 1950000),
    new Carrera("Diseño Industrial", "5 años", 26, "arquitectura", 1950000),
    new Carrera("Diseño de Indumentaria", "5 años", 26, "arquitectura", 1950000)
]

// Array de Posgrados.

const posgrados = [
    new Posgrado("Seguridad e Higiene", "1 año", 18, "cs_naturales", 320000),
    new Posgrado("Desarrollo Sustentable", "1 año", 14, "cs_naturales", 300000),

    new Posgrado("Comercio Exterior", "1 año", 15, "cs_sociales", 310000),
    new Posgrado("Derecho Constitucional", "1 año", 16, "cs_sociales", 310000),

    new Posgrado("Seguridad en la Construcción", "1 año", 18, "arquitectura", 340000),
    new Posgrado("Paisajismo", "1 año", 14, "arquitectura", 320000)
]
